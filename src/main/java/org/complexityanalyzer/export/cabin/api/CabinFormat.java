...
public final class CabinFormat {
    ...
    public static final byte SEC_FLUID_RECIPES = 0x0D;
    public static final byte SEC_FLUID_USAGE = 0x0E;
    ...
    public static final byte SEC_IDX_FLUID_HASH = 0x23;
    public static final byte SEC_IDX_FLUID_RECIPES_BY_OUTPUT = 0x24;
    ...
    public static final int FLUID_FLAG_IS_PROTECTED = 0x40;
