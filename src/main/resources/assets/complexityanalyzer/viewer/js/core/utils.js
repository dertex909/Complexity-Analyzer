...
// Создаем форматтеры один раз для экономии памяти
...
// Форматирование точных значений для всплывающих подсказок (tooltips)
...
// Флаги предметов (compact = true для таблиц, false для модальных окон)
...
// Флаги жидкостей (compact = true для таблиц, false для модалок)
